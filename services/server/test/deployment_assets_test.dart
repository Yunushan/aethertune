...
void main() {
  test(
    'self-hosting assets keep loopback and TLS deployment defaults',
    () async {
      ...
      expect(
        backupVerifyService,
        contains('Requires=aethertune-backup.service'),
      );
