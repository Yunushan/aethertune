...
| Lyrics | Add, import, edit, view, search, and delete plain text or LRC timestamped lyrics, including playback-linked synced highlighting and copyable lyrics excerpt share text |
...
| Lyrics | Plain text lyrics, UTF-8 `.txt`/`.lrc` file import, LRC timestamp parsing/preview, local saved-lyrics search, playback-linked synced highlighting, and bounded copyable lyrics excerpt share text implemented; provider lyrics, rendered lyric cards, and platform share sheets roadmap |
