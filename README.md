...
| Playlists | Built-in and custom rule smart playlists with persisted Match all/Match any criteria plus create, rename, folder organization/filtering, artwork URL edit, delete, open, find within, reorder, import/export JSON/M3U/CSV, copy playlist share text, and play manual playlists |
