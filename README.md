...
| Lyrics | Add, import, export, edit, view, search, and delete plain text or LRC timestamped lyrics, including user-triggered LRCLIB plain/synced search with local attributed caching, matching folder-scan sidecars, playback-linked synced highlighting, and attributed copyable excerpts with a bounded selected-line picker |
