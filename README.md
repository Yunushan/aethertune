...
| Multi-source | Local provider support plus Podcast RSS and Radio Browser provider foundations; self-hosted, open catalog, and official API providers remain roadmap |
