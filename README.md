...
| Lyrics | Add, edit, view, and delete plain text or LRC timestamped lyrics, including playback-linked synced highlighting and copyable lyrics excerpt share text |
...
| Lyrics | Plain text lyrics, LRC timestamp parsing/preview, playback-linked synced highlighting, and bounded copyable lyrics excerpt share text implemented; search, provider lyrics, rendered lyric cards, and platform share sheets roadmap |
