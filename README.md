...
| History/stats | Recently played tab with local playback history, typo-tolerant history search, per-play entry deletion, play counts, listening recap, monthly/yearly recap cards, date ranges, JSON/CSV stats export, top tracks/artists/albums/genres, clear action, and a persisted pause-listening-history privacy toggle |
