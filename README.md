...
| Lyrics | Add, import, export, edit, view, search, and delete plain text, LRC timestamped, SRT cue-timed, or TTML karaoke lyrics, including user-triggered LRCLIB plain/synced search with local attributed caching, matching folder-scan sidecars, playback-linked line/word highlighting, and attributed copyable excerpts with a bounded selected-line picker |
...
| Lyrics | Plain text, synced LRC, cue-timed SRT, and word-timed TTML karaoke editing, UTF-8 file/sidecar import, user-triggered LRCLIB search with local match ranking and attributed persistence, native TXT/LRC/SRT/TTML save dialogs and copyable export text, local saved-lyrics search, playback-linked line/word highlighting, bounded excerpts, and selected-line sharing implemented; rendered lyric cards, more provider adapters, and platform share sheets roadmap |
