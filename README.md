...
| Local library | Import audio files through the native file picker and sort by recently added, title, artist, or album |
...
| Queue | Play current list as a queue with next/previous controls, reorder/remove queue items, and save it as a playlist |
...
|---|---|
| Local files | Library import, playback, search, favorites, recently added sorting, folders and metadata editing roadmap |
...
| Playlists | Manual playlists, in-playlist search, track reordering, JSON/M3U/CSV import/export, and save-queue-as-playlist implemented; smart playlists roadmap |
