...
| Home feed | Local Home tab sections for continue listening, recently played, radio seeds, most played, favorites, recently added tracks, and range-filtered local charts |
...
| Music discovery | Local Home feed sections, range-filtered local charts, and seed-based track radio queues implemented; provider home feeds, provider charts, moods, richer radio, and recommendations remain roadmap |
