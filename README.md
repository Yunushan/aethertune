...
| Home feed | Local Home tab sections for recommendations, mood/activity mixes, continue listening, recently played, newest local additions from followed artists, radio seeds, most played, favorites, recently added tracks, and range-filtered local charts with responsive top-track/top-artist bars |
