...
| Music discovery | Local Home feed sections, followed-local-artist updates, range-filtered local charts, local mood/activity mixes, explainable personalized local recommendations with independent favorite/history controls, similar local tracks, and seed-based track radio queues implemented; remote creator/channel subscriptions, provider home feeds, provider charts, provider moods, richer radio, similar artist/album pages, and provider recommendations remain roadmap |
