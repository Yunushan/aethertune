...
| Multi-source | Local provider support plus Podcast RSS feed subscriptions/play/save/OPML and Radio Browser station search/play/save; self-hosted, open catalog, and official API providers remain roadmap |
