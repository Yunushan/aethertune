...
| History/stats | Recently played tab with local playback history, play counts, listening recap, monthly/yearly recap cards, date ranges, JSON/CSV stats export, top tracks/artists/albums/genres, clear action, and a persisted pause-listening-history privacy toggle |
...
| History/stats | Recently played, local play counts, estimated listening time, date-range filters, monthly/yearly calendar recap cards, JSON/CSV export, top track/artist/album/genre recap, and a persisted pause-listening-history privacy toggle implemented; richer shareable visual recap cards and charts roadmap |
