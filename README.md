...
| Music discovery | Local Home feed sections, user-refreshed self-hosted album/playlist discovery, followed-local-artist updates, range-filtered local charts, local mood/activity mixes, explainable personalized local recommendations with independent favorite/history controls, similar local tracks, related local artist/album pages, seed-based track radio, and collection-aware artist/album radio queues implemented; remote creator/channel subscriptions, provider editorial/recommendation feeds, provider charts, provider moods, provider-backed radio, provider-backed artist/album recommendations, and provider recommendations remain roadmap |
