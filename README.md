...
| Lyrics | Add, import, edit, view, and delete plain text or LRC timestamped lyrics, including playback-linked synced highlighting and copyable lyrics excerpt share text |
...
| Lyrics | Plain text lyrics, UTF-8 `.txt`/`.lrc` file import, LRC timestamp parsing/preview, playback-linked synced highlighting, and bounded copyable lyrics excerpt share text implemented; search, provider lyrics, rendered lyric cards, and platform share sheets roadmap |
