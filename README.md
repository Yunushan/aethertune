...
| Lyrics | Plain text, synced LRC, and word-timed TTML karaoke editing, UTF-8 file/sidecar import, user-triggered LRCLIB search with local match ranking and attributed persistence, native TXT/LRC/TTML save dialogs and copyable export text, local saved-lyrics search, playback-linked line/word highlighting, bounded excerpts, and selected-line sharing implemented; rendered lyric cards, more provider adapters, and platform share sheets roadmap |
