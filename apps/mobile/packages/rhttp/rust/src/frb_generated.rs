...
impl SseDecode for crate::api::client::ClientSettings {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        let mut var_maxStreamResponseBytes = <Option<u32>>::sse_decode(deserializer);
...
impl flutter_rust_bridge::IntoDart for crate::api::client::ClientSettings {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.max_stream_response_bytes.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
...
impl SseEncode for crate::api::client::ClientSettings {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <Option<u32>>::sse_encode(self.max_stream_response_bytes, serializer);
    }
}
