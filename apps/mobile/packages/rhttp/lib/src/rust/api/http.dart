...
// These functions are ignored because they are not marked as `pub`: `accept`, `build_cancel_tokens`, `extract_ip`, `from_version`, `header_to_vec`, `make_http_request_helper`, `make_http_request_inner`, `make_http_request_receive_stream_inner`, `new`, `register_client_internal`, `to_method`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `RequestCancelTokens`, `StreamResponseLimit`
