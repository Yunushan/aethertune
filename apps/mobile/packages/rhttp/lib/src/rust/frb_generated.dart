...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  ClientSettings dco_decode_client_settings(dynamic raw) {
    ...
    return ClientSettings(
      ...
      maxStreamResponseBytes: dco_decode_opt_box_autoadd_u_32(arr[9]),
    );
  }
  ...
  ClientSettings sse_decode_client_settings(SseDeserializer deserializer) {
    ...
    var var_maxStreamResponseBytes = sse_decode_opt_box_autoadd_u_32(
      deserializer,
    );
    return ClientSettings(
  ...
  void sse_encode_client_settings(
    ...
    sse_encode_opt_box_autoadd_u_32(self.maxStreamResponseBytes, serializer);
  }
