...
import 'package:aethertune/src/data/track_artwork_file_store.dart';

void main() {
  late Directory temporaryDirectory;
  late TrackArtworkFileStore store;

  setUp(() async {
    temporaryDirectory = await Directory.systemTemp.createTemp(
      'aethertune-track-artwork-test-',
    );
    store = TrackArtworkFileStore(
