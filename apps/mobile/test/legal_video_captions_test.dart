...
void main() {
  ...
  test('loads the first valid local WebVTT or SRT sidecar', () async {
    ...
    await File(
      '${directory.path}${Platform.pathSeparator}show.vtt',
    ).writeAsString('WEBVTT\n\n00:00.000 --> 00:01.000\nHello');
    await File(
      '${directory.path}${Platform.pathSeparator}show.srt',
  ...
  test(
    'skips malformed sidecars and falls back to the next valid file',
    () async {
