...
void main() {
  ...
  test(
    'clamps native Android virtualizer strength to its documented range',
    () {
  ...
  test(
    'routes primary and crossfade sessions to the native virtualizer',
    () async {
      ...
      expect(
        await bridge.attach(42, slot: AndroidAudioVirtualizerSlot.primary),
        isTrue,
      );
      expect(
        await bridge.attach(84, slot: AndroidAudioVirtualizerSlot.crossfade),
        isTrue,
      );
