...
void main() {
  test(
    'submits the completed listen with the documented metadata payload',
    () async {
      Uri? requestedUri;
      ...
      final listen =
          (document['payload'] as List<dynamic>).single as Map<String, dynamic>;
  ...
  test(
    'validates a configured user token without placing it in a URL',
    () async {
      Uri? requestedUri;
      Map<String, String>? requestedHeaders;
      final client = ListenBrainzClient(
