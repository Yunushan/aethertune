...
void main() {
  test(
    'persists bounded public followed-channel metadata across restarts',
    () async {
      ...
      await store.refresh(provider, const <YouTubeChannelFollow>[
  ...
  test(
    'strips unsafe media and local fields from a persisted cache document',
    () async {
      SharedPreferences.setMockInitialValues(<String, Object>{
