...
7. Expand the current direct-URL offline cache into a full cache/download manager with background/resumable jobs, automatic pressure eviction, per-provider quotas, checksum validation, and optional public export where legally allowed.
