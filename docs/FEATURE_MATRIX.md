...
| Lyrics sharing cards | Scaffolded | YouTube Music | Lyrics editor and now-playing lyrics sheets can copy a bounded AetherTune lyrics excerpt from saved or draft plain/LRC lyrics, stripping LRC timestamps and limiting shared lines by default. The editor can preview and save a fixed-size PNG lyric card through the native file dialog. Needed next: selected-line ranges, platform share sheets, artwork backgrounds, rights-aware provider permissions, and deep links. |
