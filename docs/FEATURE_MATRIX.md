...
| Manual playlists | Done | Persisted user playlists with add/remove/find/reorder/import/export/play UI plus playlist artwork URL display/editing in the list and playlist sheet. Native JSON/M3U/CSV file save/open and view/paste fallbacks are implemented. Store tests cover artwork persistence, clear, JSON export/import, and backup restore. | Local gallery picker, cropper, generated collage artwork, and sync. |
