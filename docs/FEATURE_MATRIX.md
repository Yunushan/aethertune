...
| Album/artist/genre/source/folder views | Done | YouTube Music, Namida | Library browse sheets group tracks by artist, album, genre, source, and imported folder; metadata scanner now reads basic ID3v2 MP3, FLAC Vorbis, and M4A genre text plus embedded MP3/FLAC/M4A artwork. Richer tag formats and album-level artwork grouping remain. |
...
|---|---:|---|---|
| Local files | Done | Namida, Musify | Recursive folder scanner, filename metadata parser, basic ID3v1 MP3 title/artist/album tag parser, basic ID3v2 MP3 title/artist/album/genre text-frame and APIC/PIC artwork parser, basic FLAC Vorbis comment title/artist/album/genre and picture artwork parser, and basic M4A title/artist/album/genre atom plus `covr` artwork parser are implemented; richer tag parsing, artwork editing, and folder watch remain. |
