...
| Local audio import | Done | Native file picker plus recursive folder scanner for supported audio extensions, including filename track-number parsing, artist/title parsing, basic ID3v1 MP3 title/artist/album tag parsing, basic ID3v2 MP3 title/artist/album/genre text-frame parsing, and basic FLAC Vorbis comment title/artist/album/genre parsing with scanner tests. | Folder watch, scoped storage UX, M4A tags, artwork extraction, and richer embedded tag parsing. |
...
| Metadata scanner | Scaffolded | Namida | Folder import derives album/folder metadata from parent folders, parses common filename patterns such as leading track numbers and `Artist - Title`, reads basic ID3v1 MP3 title/artist/album tags, reads basic ID3v2 MP3 title/artist/album/genre text frames, and reads basic FLAC Vorbis comment title/artist/album/genre tags before falling back to filenames; scanner tests cover recursive import, dashed titles, ID3v1/ID3v2/FLAC tag preference, UTF-16 ID3v2 text, partial tag merges, and tag fallback. Needed next: M4A tags, artwork extraction, background indexing. |
...
| Album/artist/genre/source/folder views | Done | YouTube Music, Namida | Library browse sheets group tracks by artist, album, genre, source, and imported folder; metadata scanner now reads basic ID3v2 MP3 and FLAC Vorbis genre text, while M4A genre tags and richer tag formats remain. |
...
|---|---:|---|---|
| Local files | Done | Namida, Musify | Recursive folder scanner, filename metadata parser, basic ID3v1 MP3 title/artist/album tag parser, basic ID3v2 MP3 title/artist/album/genre text-frame parser, and basic FLAC Vorbis comment title/artist/album/genre parser are implemented; M4A tags, artwork extraction, richer tag parsing, and folder watch remain. |
