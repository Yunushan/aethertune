...
| Local audio import | Done | Native file picker plus recursive folder scanner for supported audio extensions, including filename track-number parsing, artist/title parsing, basic ID3v1 MP3 title/artist/album tag parsing, basic ID3v2 MP3 title/artist/album/genre text-frame parsing, basic FLAC Vorbis comment title/artist/album/genre parsing, and basic M4A title/artist/album/genre atom parsing with scanner tests. | Folder watch, scoped storage UX, artwork extraction, and richer embedded tag parsing. |
...
| Metadata scanner | Scaffolded | Namida | Folder import derives album/folder metadata from parent folders, parses common filename patterns such as leading track numbers and `Artist - Title`, reads basic ID3v1 MP3 title/artist/album tags, reads basic ID3v2 MP3 title/artist/album/genre text frames, reads basic FLAC Vorbis comment title/artist/album/genre tags, and reads basic M4A title/artist/album/genre metadata atoms before falling back to filenames; scanner tests cover recursive import, dashed titles, ID3v1/ID3v2/FLAC/M4A tag preference, UTF-16 ID3v2 text, partial tag merges, and tag fallback. Needed next: artwork extraction, background indexing, and richer tag formats. |
...
| Album/artist/genre/source/folder views | Done | YouTube Music, Namida | Library browse sheets group tracks by artist, album, genre, source, and imported folder; metadata scanner now reads basic ID3v2 MP3, FLAC Vorbis, and M4A genre text, while artwork and richer tag formats remain. |
...
|---|---:|---|---|
| Local files | Done | Namida, Musify | Recursive folder scanner, filename metadata parser, basic ID3v1 MP3 title/artist/album tag parser, basic ID3v2 MP3 title/artist/album/genre text-frame parser, basic FLAC Vorbis comment title/artist/album/genre parser, and basic M4A title/artist/album/genre atom parser are implemented; artwork extraction, richer tag parsing, and folder watch remain. |
