...
Podcast RSS episodes with inline Podlove Simple Chapters or same-origin Podcasting 2.0 chapter documents show their markers automatically in Now Playing. AetherTune does not request chapter documents hosted outside the feed's declared origin.
