...
- Podcast RSS: add a legal RSS feed URL in Sources, import/export OPML, then refresh, play, resume, save, queue/cache eligible feed enclosures, trim/clear private cached media, set provider cache quotas, or remove feed episodes. Background/resumable downloads remain roadmap work.
